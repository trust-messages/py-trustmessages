# Auto-generated by asn1ate on 2017-03-09 15:32:42.556332
...
class Data(univ.Sequence):
    pass


Data.tagSet = univ.Sequence.tagSet.tagImplicitly(tag.Tag(tag.tagClassApplication, tag.tagFormatConstructed, 4))
...
DataResponse.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType('response', univ.SequenceOf(componentType=Data()))
)
